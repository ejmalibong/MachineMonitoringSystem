...
Public Class FacMchSched
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            Using frm As New FacMchSchedDetail(userId)
                frm.ShowDialog(Me)
                Reload()
            ...
            If Me.dgvList.Rows.Count > 0 Then
                ...
                Else
                    If MessageBox.Show(question, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                        ...
                        dbMethod.ExecuteNonQuery("DelFacMachineSchedule", CommandType.StoredProcedure, prmDel)
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        Try
            If Me.dgvList.Rows.Count > 0 Then
                ...
                Using frm As New FacMchSchedDetail(userId, schedId)
    ...
    Private Sub LoadMachine()
        dbMethod.FillCmbWithCaption("RdFacMachine", CommandType.StoredProcedure, "MachineId", "MachineCode", cmbCommon, "< All >")
    End Sub
    ...
    Private Sub LoadSchedule()
        Try
            ...
            If isFilterByMachine = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlistByMachineId", CommandType.StoredProcedure, prmSchedule)
            ...
            ElseIf isFilterByMonth = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlistByMonthId", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByWeek = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlistByWeekId", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByCreatedBy = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlistByCreatedBy", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByActivityBy = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlistByActivityBy", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByActivityDate = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlistByActivityDate", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByStatus = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlistByStatus", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            Else
                ...
                dtSchedule = dbMethod.FillDataTable("RdFacMachineScheduleMasterlist", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            End If
