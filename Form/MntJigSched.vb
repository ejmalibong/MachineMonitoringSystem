...
Public Class MntJigSched
    ...
    Private isFilterByJig As Boolean = False
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        Try
            Using frm As New MntJigSchedDetail(userId)
                frm.ShowDialog(Me)
                Reload()
            ...
            If Me.dgvList.Rows.Count > 0 Then
                ...
                Else
                    If MessageBox.Show(question, "", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                        ...
                        dbMethod.ExecuteNonQuery("DelMntJigSchedule", CommandType.StoredProcedure, prmDel)
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        Try
            If Me.dgvList.Rows.Count > 0 Then
                ...
                Using frm As New MntJigSchedDetail(userId, schedId)
    ...
    Private Sub LoadJig()
        dbMethod.FillCmbWithCaption("RdMntJig", CommandType.StoredProcedure, "JigId", "JigCompleteName", cmbCommon, "< All >")
    End Sub
    ...
    Private Sub LoadSchedule()
        Try
            ...
            If isFilterByJig = True Then
                ...
                prmSchedule(4) = New SqlParameter("@JigId", SqlDbType.Int)
                prmSchedule(4).Value = IIf(cmbCommon.SelectedValue = 0, Nothing, cmbCommon.SelectedValue)

                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlistByJigId", CommandType.StoredProcedure, prmSchedule)
            ...
            ElseIf isFilterByMonth = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlistByMonthId", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByWeek = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlistByWeekId", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByCreatedBy = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlistByCreatedBy", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByActivityBy = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlistByActivityBy", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByActivityDate = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlistByActivityDate", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            ...
            ElseIf isFilterByStatus = True Then
                ...
                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlistByStatus", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            Else
                ...
                dtSchedule = dbMethod.FillDataTable("RdMntJigScheduleMasterlist", CommandType.StoredProcedure, prmSchedule)
                totalCount = prmSchedule(2).Value
            End If
