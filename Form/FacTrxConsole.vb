...
Public Class FacTrxConsole
    ...
    Private Sub MachineRelatedToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles MachineRelatedToolStripMenuItem.Click
        Try
            Using frmDetail As New FacTrxDetailMch(userId, workgroupId, isAdmin)
    ...
    Private Sub LoadMachine()
        Try
            ...
            dtMachine = dbMethod.FillDataTable("RdFacMachineAccumulatedTime", CommandType.StoredProcedure, prmMachine)
