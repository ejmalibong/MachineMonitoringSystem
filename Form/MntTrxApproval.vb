...
Public Class MntTrxApproval
    Private connection As New Connection
    Private dbLeaveFiling As New SqlDbMethod(connection.GetConnectionString)
    ...
    Private Sub btnSearchDate_Click(sender As Object, e As EventArgs)
        Try
    ...
    Private Sub btnResetDate_Click(sender As Object, e As EventArgs)
        Try
            'If rdApproved.Checked = True Then
            '    'sr manager, engg manager
            '    If workgroupId = 2 Or workgroupId = 3 Then
