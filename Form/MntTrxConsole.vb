...
Public Class MntTrxConsole
    ...
    Private Sub LoadSearchCriteria()
        ...
        dicSearchCriteria.Add(" Machine Name", 2)
        dicSearchCriteria.Add(" Machine Status", 3)
        dicSearchCriteria.Add(" Jig Name", 4)
        dicSearchCriteria.Add(" Jig Status", 5)
        dicSearchCriteria.Add(" Area", 6)
        dicSearchCriteria.Add(" Date Started", 7)
        dicSearchCriteria.Add(" Date Ended", 8)
        dicSearchCriteria.Add(" Problem", 9)
        dicSearchCriteria.Add(" Root Cause", 10)
        dicSearchCriteria.Add(" Action Taken", 11)
        dicSearchCriteria.Add(" Username", 12)
        dicSearchCriteria.Add(" Shift", 13)
        dicSearchCriteria.Add(" JO Number", 14)
        dicSearchCriteria.Add(" JO Requestor", 15)
        ...
        Try
            ...
            Else
                ...
                ElseIf cmbStatus.SelectedValue = 7 Then 'all records
                    ...
                    'prmRouting(3) = New SqlParameter("@RoutingStatusId", SqlDbType.Int)
                    'prmRouting(3).Value = Nothing
                    'prmRouting(4) = New SqlParameter("@SortingCol", SqlDbType.VarChar)
                    'prmRouting(4).Value = cmbSortCriteria.SelectedValue
                    'prmRouting(5) = New SqlParameter("@SortType", SqlDbType.VarChar)
                    'prmRouting(5).Value = GetSortMode()
