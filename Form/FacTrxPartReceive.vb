...
Public Class FacTrxPartReceive
    ...
    Public Sub New(Optional _userId As Integer = 0, Optional _partTrxId As Integer = 0)
        ...
        prmPart(0).Value = 1
        dtSparePart = dbMethod.FillDataTable("SELECT PartId, TRIM(PartNo) AS PartNo, TRIM(PartName) AS PartName FROM dbo.FacSparePart WHERE IsActive = @IsActive", CommandType.Text, prmPart)
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            For Each row As DataGridViewRow In dgvPartDetail.Rows
                ...
                dbMethod.ExecuteNonQuery("UpdFacSparePartRec", CommandType.StoredProcedure, prmIss)
            Next
    ...
    Private Sub cmbPartSelection_SelectedValueChanged(sender As Object, e As EventArgs) Handles cmbPartSelection.SelectedValueChanged
        Try
            ...
            If cmbPartSelection.SelectedValue = 1 Then
                ...
                dbMethod.FillCmbWithCaption("SELECT PartId, TRIM(PartName) + ' ' + TRIM(PartNo) AS PartName FROM dbo.FacSparePart WHERE IsActive = 1",
            ...
            Else
                ...
                dbMethod.FillCmbWithCaption("SELECT PartId, TRIM(PartNo) AS PartNo FROM dbo.FacSparePart WHERE IsActive = 1",
    ...
    Private Function CreateFacTransactionPartDetail() As DataTable
    ...
    Private Sub FacTrxPartReceive_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Try
            If partTrxId <> 0 Then
