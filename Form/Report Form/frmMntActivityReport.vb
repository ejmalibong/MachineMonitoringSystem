...
Public Class frmMntActivityReport
    ...
    Private Sub frmMntActivityReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            method.FillCmbWithCaption("ReadSecUserBySectionId", "UserId", "UserName", cmbTechnician, " < All Technician > ", _paramsUser)
            method.FillCmbWithCaption("ReadGenTransactionStatus", "TrxStatusId", "TrxStatusName", cmbTrxStatus, " < All Status > ")
            method.FillCmbWithCaption("ReadMntMachineStatus", "MachineStatusId", "MachineStatusName", cmbStatus, " < All Status > ", _paramsStatus)
            method.FillCmbWithCaption("ReadMntArea", "AreaId", "AreaName", cmbArea, " < All Area > ")
