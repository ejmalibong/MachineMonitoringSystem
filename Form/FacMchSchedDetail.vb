...
Public Class FacMchSchedDetail
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If scheduleId = 0 Then 'new record
                ...
                dbMethod.ExecuteNonQuery("InsFacMachineSchedule", CommandType.StoredProcedure, prmSchd)
                ...
                For Each frm As Form In Application.OpenForms
                    If frm.Name = "FacMchSched" Then
                        Dim frmMchSchd As FacMchSched = DirectCast(frm, FacMchSched)
                        frmMchSchd.Reload()
            ...
            Else 'old record
                ...
                dbMethod.ExecuteNonQuery("UpdFacMachineSchedule", CommandType.StoredProcedure, prmSchd)
    ...
    Private Sub cmbMachineName_SelectedValueChanged(sender As Object, e As EventArgs)
        Try
            ...
            Else
                ...
                Dim rdr As IDataReader = dbMethod.ExecuteReader("RdFacMachine", CommandType.StoredProcedure, prm)
    ...
    Private Sub LoadMachine()
        Try
            cmbMachineName.DisplayMember = "MachineCode"
            ...
            dbMethod.FillCmbWithCaption("RdFacMachine", CommandType.StoredProcedure, "MachineId", "MachineCode", cmbMachineName, "< Select Machine >", prmMch)
    ...
    Private Sub MntMchSchedDetail_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            dtSchedule = dbMethod.FillDataTable("RdFacMachineSchedule", CommandType.StoredProcedure, prmsched)
            ...
            Select Case frequencyId
                Case "M"
                    If scheduleId = 0 Then
                        ...
                        count = dbMethod.ExecuteScalar("SELECT COUNT(ScheduleId) FROM dbo.FacMachineSchedule " &
