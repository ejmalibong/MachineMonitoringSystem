...
Public Class MntMchCs
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        Try
            If cmbMachineName.SelectedValue = 0 Then
                MessageBox.Show("No machine selected.", "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Return
            End If
    ...
    Private Sub cmbMachineName_Validated(sender As Object, e As EventArgs)
        If cmbMachineName.Text.Trim.Length = 0 Or cmbMachineName.SelectedValue = 0 Then
            cmbMachineName.SelectedValue = 0
        End If
    End Sub
    ...
    Private Sub LoadData()
        Try
            ...
            prmMasterlist(0) = New SqlParameter("@MachineId", SqlDbType.Int)
            prmMasterlist(0).Value = cmbMachineName.SelectedValue
            ...
            dtChecksheet = dbMethod.FillDataTable("RdMntMachineChecksheet", CommandType.StoredProcedure, prmMasterlist)
            ...
            If Me.dgvList.Rows.Count > 0 Then
                If Not CType(Me.bsChecksheet.Current, DataRowView).Item("LinkChecksheet") Is DBNull.Value Then
                    ...
                    ElseIf e.ColumnIndex = 7 Then 'view activity
                        ...
                        Dim frmDetail As New MntTrxDetailMch(0, 0, 0, trxId)
