...
Public Class MntJigSchedDetail
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If scheduleId = 0 Then 'new record
                If IsSchedExists(cmbJigName.SelectedValue, frequencyId, cmbMonth.SelectedValue, CInt(txtYearId.Text)) = True Then
                ...
                prmSchd(6) = New SqlParameter("@JigId", SqlDbType.Int)
                prmSchd(6).Value = cmbJigName.SelectedValue
                ...
                dbMethod.ExecuteNonQuery("InsMntJigSchedule", CommandType.StoredProcedure, prmSchd)
                ...
                For Each frm As Form In Application.OpenForms
                    If frm.Name = "MntJigSched" Then
                        Dim frmJigSchd As MntJigSched = DirectCast(frm, MntJigSched)
                        frmJigSchd.Reload()
                        frmJigSchd.bsSchedule.Position = frmJigSchd.bsSchedule.Find("ScheduleId", pKey)
                    End If
                Next
            ...
            Else 'old record
                ...
                prmSchd(3) = New SqlParameter("@WeekId", SqlDbType.Int)
                prmSchd(3).Value = cmbWeekNo.SelectedValue
                prmSchd(4) = New SqlParameter("@JigId", SqlDbType.Int)
                prmSchd(4).Value = cmbJigName.SelectedValue
                ...
                dbMethod.ExecuteNonQuery("UpdMntJigSchedule", CommandType.StoredProcedure, prmSchd)
    ...
    Private Sub cmbJigName_SelectedValueChanged(sender As Object, e As EventArgs)
        Try
            ...
            Else
                ...
                prm(0).Value = cmbJigName.SelectedValue

                Dim rdr As IDataReader = dbMethod.ExecuteReader("RdMntJig", CommandType.StoredProcedure, prm)
    ...
    Private Sub MntMchSchedDetail_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else
            ...
            dtSchedule = dbMethod.FillDataTable("RdMntJigSchedule", CommandType.StoredProcedure, prmsched)
    ...
    Private Function IsSchedExists(jigId As Integer, frequencyId As String, monthId As Integer, yearId As Integer,
            ...
            Select Case frequencyId
                ...
                Case "Q"
                    ...
                    If scheduleId = 0 Then
                        ...
                        count = dbMethod.ExecuteScalar("SELECT COUNT(ScheduleId) FROM dbo.MntJigSchedule " &
                                                       "WHERE JigId = @JigId AND YearId = @YearId " &
                ...
                Case "A"
                    If scheduleId = 0 Then
                        ...
                        count = dbMethod.ExecuteScalar("SELECT COUNT(ScheduleId) FROM dbo.MntJigSchedule " &
                                                       "WHERE JigId = @JigId AND YearId = @YearId", CommandType.Text, prm)
                    Else
                        Dim prm(2) As SqlParameter
                        prm(0) = New SqlParameter("@JigId", SqlDbType.Int)
                        prm(0).Value = jigId
                        ...
                        count = dbMethod.ExecuteScalar("SELECT COUNT(ScheduleId) FROM dbo.MntJigSchedule " &
                                                       "WHERE JigId = @JigId AND YearId = @YearId AND ScheduleId <> @ScheduleId", CommandType.Text, prm)
                    End If
