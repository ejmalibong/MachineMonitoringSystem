...
Public Class FacSparePartDetail
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            If String.IsNullOrEmpty(txtPartName.Text.Trim) Then
                MessageBox.Show("Specifications is required.", "", MessageBoxButtons.OK, MessageBoxIcon.Error)
                txtPartName.Focus()
                Return
            End If
            ...
            If partId = 0 Then 'new record
                ...
                dbMethod.ExecuteNonQuery("InsFacSparePart", CommandType.StoredProcedure, prmPart)
            ...
            Else 'old record
                ...
                dbMethod.ExecuteNonQuery("UpdFacSparePart", CommandType.StoredProcedure, prmPart)
                pKey = partId
            End If
    ...
    Private Function IsPartExist(partNo As String) As Boolean
        ...
        Try
            ...
            count = dbMethod.ExecuteScalar("SELECT COUNT(PartId) FROM dbo.FacSparePart WHERE TRIM(PartNo) = @PartNo", CommandType.Text, prmCnt)
        Catch ex As Exception
            MessageBox.Show(dbMain.SetExceptionMessage(ex), "", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    ...
    Private Sub LoadItemType()
        Try
            dbMethod.FillCmbWithCaption("RdFacSparePartItemType", CommandType.StoredProcedure, "ItemTypeId", "ItemTypeName", cmbItemType, "< Select Item Type >")
    ...
    Private Sub LoadLocation()
        Try
            dbMethod.FillCmbWithCaption("RdFacSparePartLocation", CommandType.StoredProcedure, "LocationId", "LocationName", cmbLocation, "< Select Location >")
    ...
    Private Sub LoadMachineType()
        Try
            dbMethod.FillCmbWithCaption("RdFacSparePartMachineType", CommandType.StoredProcedure, "MachineTypeId", "MachineTypeName", cmbMachineType, "< Select Machine Type >")
    ...
    Private Sub LoadUnit()
        Try
            dbMethod.FillCmbWithCaption("RdFacSparePartUnit", CommandType.StoredProcedure, "UnitId", "UnitName", cmbUnit, "< Select Unit >")
    ...
    Private Sub LoadVendor()
        Try
            dbMethod.FillCmbWithCaption("RdFacSparePartVendor", CommandType.StoredProcedure, "VendorId", "VendorName", cmbVendor, "< Select Vendor >")
    ...
    Private Sub FacMchSchedDetail_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                dtPart = dbMethod.FillDataTable("RdFacSparePart", CommandType.StoredProcedure, prmPart)
